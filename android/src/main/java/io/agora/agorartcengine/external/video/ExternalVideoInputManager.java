...
import io.agora.agorartcengine.external.video.gles.core.GlUtil;
import io.agora.agorartcengine.external.video.screenshare.ScreenShareInput;
...
public class ExternalVideoInputManager implements IVideoSource {
    ...
    boolean setExternalVideoInput(int type, Intent intent) {
        ...
        switch (type) {
            ...
            case TYPE_SCREEN_SHARE:
                ...
                input = new ScreenShareInput(mContext ,width, height, dpi, fps, intent);
                break;
            default:
                 input = null;
        }
    ...
    private class ExternalVideoInputThread extends Thread {
        ...
        private void release() {
            ...
            AgoraRtcEnginePlugin.getRtcEngine().setVideoSource(new AgoraDefaultSource());
            mSurface.release();
